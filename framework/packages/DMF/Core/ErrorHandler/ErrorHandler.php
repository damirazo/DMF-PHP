<?php
    ...
    // Теперь обработчик ошибок вызывает себя сам в момент инициализации
    // Хотя выглядит не очень красиво и возможно стоит придумать другой способ вынести его вызов
    ErrorHandler::run();
